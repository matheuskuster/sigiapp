...
routes.use('/app', authMiddleware) // todas as rotas que comecam com /app devem passar pelo authMiddleware
...
// GERADOR DE PLACAS
routes.get('/board/:id', controllers.BoardController.index) // Gera as placas do comitê
